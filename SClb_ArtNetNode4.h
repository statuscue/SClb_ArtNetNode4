...
#ifndef _SClb_ArtNetNode4_h
#define _SClb_ArtNetNode4_h
...
class SCArtNet4 : public SClb_Arduino_DMXEthernet {
...
public:
	...
	*/
	SCArtNet4(IPAddress address, IPAddress subnet_mask, uint8_t* buffer);


	/*!
	* @brief destructor for SCArtNet4 (frees packet buffer if allocated with constructor)
	*/
	~SCArtNet4(void);
...
#endif // ifndef SClb_ArtNetNode4_H
